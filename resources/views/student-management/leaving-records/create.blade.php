...
<head>
    ...
    <title>Tambah Catatan Kelulusan/Keluar</title>
</head>

<body>
    <h1>Tambah Catatan Kelulusan/Keluar</h1>
    ...
    <form action="{{ route('leaving-records.store') }}" method="POST">
        @csrf
        ...
        <p>
            ...
            <input type="text" name="entry_type" id="entry_type" maxlength="10" value="{{ old('entry_type') }}"
                required>
        </p>

        <p>
            <label for="letter_type">Tipe Surat</label><br>
            <input type="text" name="letter_type" id="letter_type" maxlength="100" value="{{ old('letter_type') }}"
                required>
        </p>
        ...
        <p>
            ...
            <input type="text" name="destination_institution" id="destination_institution" maxlength="50"
                value="{{ old('destination_institution') }}" required>
        </p>
        ...
        <p>
            ...
            <input type="text" name="destination_age_group_level" id="destination_age_group_level" maxlength="50"
                value="{{ old('destination_age_group_level') }}" required>
        </p>

        <p>
            <label for="transfer_date">Tanggal Transfer</label><br>
            <input type="date" name="transfer_date" id="transfer_date" value="{{ old('transfer_date') }}" required>
        </p>

        <p>
            <label for="exit_date">Tanggal Keluar</label><br>
            <input type="date" name="exit_date" id="exit_date" value="{{ old('exit_date') }}" required>
        </p>
